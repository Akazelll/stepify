            ...
            <div class="lg:col-span-4 sticky top-24">
                <div
                    ...
                    <form action="{{ route('tutorial.details.store', $tutorial->id) }}" method="POST"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-[#020617] mb-1.5">Teks / Penjelasan</label>
                ...
                @forelse($details as $detail)
                    <div
                        ...
                        <div class="space-y-5">
                            ...
                            @if ($detail->image)
                                <div class="bg-slate-50 rounded-2xl p-3 border border-slate-100 flex justify-center">
